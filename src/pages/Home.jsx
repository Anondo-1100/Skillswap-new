      ...
      <div className="mx-auto px-4 py-16 container">
        ...
        <div className="gap-8 grid grid-cols-1 md:grid-cols-3 mb-20">
          <div className="bg-white shadow-lg hover:shadow-xl p-8 rounded-xl transition-shadow">
            ...
            <p className="text-gray-600">Transform your knowledge into opportunities. Help others grow while building your teaching portfolio.</p>
          </div>
          <div className="bg-white shadow-lg hover:shadow-xl p-8 rounded-xl transition-shadow">
            <div className="mb-4 text-indigo-600">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-gray-600">Access a diverse range of skills taught by experts. Learn at your own pace through direct interactions.</p>
          </div>
          <div className="bg-white shadow-lg hover:shadow-xl p-8 rounded-xl transition-shadow">
            <div className="mb-4 text-indigo-600">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
